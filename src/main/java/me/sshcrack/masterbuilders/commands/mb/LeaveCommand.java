...
import me.sshcrack.masterbuilders.tools.thread.LeaveCommandThread;
...
public class LeaveCommand extends SubCommand {
    ...
    public CommandResponse onCommand(CommandSender sender, String label, String[] args) {
        ...
        LeaveCommandThread instance = new LeaveCommandThread(sender, label, args);
        executioners.add(sender);
        instance.doneCallback(() -> {
            Bukkit.getLogger().info(String.format("Done callback for leave %s", sender.getName()));
