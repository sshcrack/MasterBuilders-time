...
public class RegionCommand extends SubCommand {
    ...
    public CommandResponse onCommand(CommandSender sender, String label, String[] args) {
        ...
        Location relativeSpawn = player.getLocation().subtract(start);
        relativeSpawn.setYaw(player.getLocation().getYaw());
        relativeSpawn.setPitch(player.getLocation().getPitch());

        config.set("start", LocTools.locToStr(start));
        config.set("end", LocTools.locToStr(end));
        config.set("spawn", LocTools.locToStr(relativeSpawn));
    ...
    public String getHelp() {
        return "Set the region of the plot to copy";
    }
